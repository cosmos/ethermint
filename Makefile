...
SET_PROJECT_APPNAME = -X main.appName=${APP_NAME} -X main.shortAppName=${APP_NAME} -X app.appName=${APP_NAME} -X app.shortAppName=${APP_NAME} -X types.appName=${APP_NAME} -X evm.appName=${APP_NAME} 
