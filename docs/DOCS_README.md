...
If you want to open a PR on the Cosmos SDK to update the documentation, please follow the guidelines in the [`CONTRIBUTING.md`](https://github.com/cosmos/aragon-chain/tree/master/CONTRIBUTING.md#updating-documentation)
...
The documentation for Aragon-Chain is hosted at https://docs.aragon-chain.zone/

built from the files in this (`/docs`) directory for
[master](https://github.com/cosmos/aragon-chain/tree/master/docs).
