...
model: [https://trunkbaseddevelopment.com/](https://trunkbaseddevelopment.com/).
...
* On the `RC` branch, prepare a new version section in the `CHANGELOG.md`. All links must be
  link-ified: `$ python ./scripts/linkify_changelog.py CHANGELOG.md`. Copy the entries into a `RELEASE_CHANGELOG.md`,
