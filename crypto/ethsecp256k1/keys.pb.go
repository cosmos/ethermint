...
// source: ethermint/crypto/v1beta1/ethsecp256k1/keys.proto
...
func (*PubKey) Descriptor() ([]byte, []int) {
	return fileDescriptor_6b5db6b57f4f214a, []int{0}
}
...
func (*PrivKey) Descriptor() ([]byte, []int) {
	return fileDescriptor_6b5db6b57f4f214a, []int{1}
}
...
func init() {
	proto.RegisterType((*PubKey)(nil), "ethermint.crypto.v1beta1.ethsecp256k1.PubKey")
	proto.RegisterType((*PrivKey)(nil), "ethermint.crypto.v1beta1.ethsecp256k1.PrivKey")
}

func init() {
	proto.RegisterFile("ethermint/crypto/v1beta1/ethsecp256k1/keys.proto", fileDescriptor_6b5db6b57f4f214a)
}

var fileDescriptor_6b5db6b57f4f214a = []byte{
	// 200 bytes of a gzipped FileDescriptorProto
	0x1f, 0x8b, 0x08, 0x00, 0x00, 0x00, 0x00, 0x00, 0x02, 0xff, 0xe2, 0x32, 0x48, 0x2d, 0xc9, 0x48,
	...
	0x18, 0x3e, 0x43, 0x76, 0x5f, 0x12, 0x1b, 0xd8, 0x41, 0xc6, 0x80, 0x00, 0x00, 0x00, 0xff, 0xff,
	0xe4, 0x43, 0xf2, 0xb9, 0x01, 0x01, 0x00, 0x00,
}
