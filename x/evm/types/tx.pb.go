...
type TxData struct {
	...
	// imput defines the data payload bytes of the transaction.
...
func (*EIP155Signer) Descriptor() ([]byte, []int) {
	return fileDescriptor_64c167cc7506bfea, []int{5}
}
...
func init() {
	...
	proto.RegisterType((*Recipient)(nil), "ethermint.evm.v1beta1.Recipient")
...
var fileDescriptor_64c167cc7506bfea = []byte{
	...
	,
}
