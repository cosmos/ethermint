...
// AragonGenesis contains the aragonOS contracts loaded at genesis
func (AppModuleBasic) AragonGenesis(cdc codec.JSONMarshaler) json.RawMessage {
	return cdc.MustMarshalJSON(types.AragonGenesisState())
}
